        ...
        $.post(ajaxUrl,
                ...
                function(response){
                    ...
                    data.forEach(function(element) {
                        html += "<li>";
                        html += '<div class="row" style="margin-left: 15px;margin-right: 0px;"><div style="width:5%;float:left;"><i style="font-size:21px;" class="mdi mdi-file-hidden"></i></div>';
                        html += '<div style="width:15%;float:left;"><span style="font-size: 18px;">'+element[1]+"</span><p>created 5days ago</p>"+'</div>';
                        html += '<div style="width:12%;float:left;"><span style="color:#fc4b6c;font-size: 18px;">'+element[2]+"</span><p>listid</p>"+"</div>";
                        html += '<div style="width:8%;float:left;"><span style="font-size: 18px;">'+element[3]+"</span><p>contacts</p>"+"</div>";
                        html += '<div style="width:40%;float:left;"><span style="font-size: 18px;">'+element[4]+"</span><p>description</p>"+"</div>";
                        html += '<div style="width:20%;float:left;">';
                        html += '<a href="/lists/edit/'+element[5]+'"><i class="mdi mdi-account-multiple-outline" style="font-size: 30px;color: #67757c;"></i></a>&nbsp;&nbsp;';
                        html += '<a href="/lists/edit/'+element[5]+'"><i class="mdi mdi-settings" style="font-size: 30px;color: #67757c;"></i></a>&nbsp;&nbsp;';
                        html += '<a href="/lists/delete/'+element[5]+'" type="button" class="btn waves-effect waves-light btn-danger" style="color:white;margin-top: 0px;">delete</a></div>';
                        html += "</div></li>";
                    }, this);
                    $('#list_view_tbl').html(html);
                },"json");
    });
